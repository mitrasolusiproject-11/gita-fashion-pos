...
async function GET(request) {
    try {
        ...
        const allProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select({
        ...
        const todaySales = todayTransactions.reduce((sum, t)=>sum + (t.cashAmount || 0) + (t.transferAmount || 0), 0);
        const todayTransactionCount = todayTransactions.length;
        const todayItems = todayTransactions.reduce((sum, t)=>sum + (t.totalItems || 0), 0);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            totalProducts,
            todaySales,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08844865._.js.map