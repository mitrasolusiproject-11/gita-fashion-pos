...
function verifyTokenFromCookie(token) {
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].verify(token, JWT_SECRET);
    } catch (error) {
        return null;
    }
}
async function middleware(request) {
    ...
    if (pathname.startsWith('/api/') || pathname.startsWith('/_next/') || pathname.startsWith('/login') || pathname === '/') {
    ...
    if (pathname.startsWith('/dashboard')) {
        ...
        if ((pathname.startsWith('/dashboard/products') || pathname.startsWith('/dashboard/customers') || pathname.startsWith('/dashboard/reports')) && ![
            'ADMIN',
            'MANAGER'
        ].includes(userRole)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/dashboard', request.url));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3543ee54._.js.map