...
function AuthProvider({ children }) {
    ...
    const checkSession = async ()=>{
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientSession"])();
            setUser(user);
        } catch (error) {
    ...
    const signOut = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clientSignOut"])();
            setUser(null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c5c34bf._.js.map