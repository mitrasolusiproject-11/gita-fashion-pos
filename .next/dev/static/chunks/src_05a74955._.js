...
function POSPage() {
    ...
    const fetchProducts = async ()=>{
        try {
            const response_0 = await fetch('/api/products', {
                credentials: 'include'
            });
            if (response_0.ok) {
                const data_0 = await response_0.json();
                setProducts(Array.isArray(data_0) ? data_0.slice(0, 10) : []); // Show first 10 products
            }
        } catch (error_0) {
    ...
    const addToCart = (product)=>{
        ...
        if (existingItem) {
            ...
            setCart(cart.map((item_0)=>item_0.barcode === product.barcode ? {
                    ...item_0,
    ...
    const scanBarcode = async ()=>{
        ...
        try {
            const response_1 = await fetch(`/api/products/${barcode}`, {
                credentials: 'include'
            });
            if (response_1.ok) {
                const product_0 = await response_1.json();
                addToCart(product_0);
                setBarcode('');
            } else {
            ...
            console.error('Error scanning barcode:', error_1);
            alert('Terjadi kesalahan saat scan barcode');
        }
    };
    const updateQuantity = (barcode_0, newQuantity)=>{
        if (newQuantity <= 0) {
            removeFromCart(barcode_0);
            return;
        }
        const product_1 = products.find((p)=>p.barcode === barcode_0);
        if (product_1 && newQuantity > product_1.currentStock) {
            alert('Quantity melebihi stok yang tersedia!');
            return;
        }
        setCart(cart.map((item_1)=>item_1.barcode === barcode_0 ? {
                ...item_1,
                quantity: newQuantity
            } : item_1));
    };
    const removeFromCart = (barcode_1)=>{
        setCart(cart.filter((item_2)=>item_2.barcode !== barcode_1));
    };
    const clearCart = ()=>{
        setCart([]);
    };
    const openDiscountDialog = (item_3)=>{
        setDiscountItem(item_3);
        setDiscountValue(item_3.discount);
        setDiscountType(item_3.discountType);
        setShowDiscountDialog(true);
    };
    const applyDiscount = ()=>{
        if (!discountItem) return;
        const updatedCart = cart.map((item_4)=>{
            if (item_4.barcode === discountItem.barcode) {
                return {
                    ...item_4,
    ...
    const calculateItemDiscount = (item_5)=>{
        const subtotal = item_5.price * item_5.quantity;
        if (item_5.discountType === 'percentage') {
            return subtotal * item_5.discount / 100;
        } else {
            return item_5.discount;
        }
    };
    const calculateTotal = ()=>{
        return cart.reduce((total, item_6)=>{
            const subtotal_0 = item_6.price * item_6.quantity;
            const discount = calculateItemDiscount(item_6);
            return total + subtotal_0 - discount;
        }, 0);
    };
    const calculateSubtotal = ()=>{
        return cart.reduce((total_0, item_7)=>total_0 + item_7.price * item_7.quantity, 0);
    };
    const calculateTotalDiscount = ()=>{
        return cart.reduce((total_1, item_8)=>total_1 + calculateItemDiscount(item_8), 0);
    };
    const setAutoAmount = (method)=>{
        const total_2 = calculateTotal();
        if (method === 'cash') {
            setCashAmount(total_2);
            setTransferAmount(0);
        } else if (method === 'transfer') {
            setTransferAmount(total_2);
            setCashAmount(0);
        }
    };
    const processPayment = async ()=>{
        ...
        const total_3 = calculateTotal();
        const totalPaid = cashAmount + transferAmount;
        if (totalPaid < total_3) {
        ...
        try {
            const transactionData = {
                items: cart.map((item_9)=>({
                        barcode: item_9.barcode,
                        name: item_9.name,
                        quantity: item_9.quantity,
                        price: item_9.price,
                        discount: item_9.discount,
                        discountPercent: item_9.discountType === 'percentage' ? item_9.discount : 0,
                        discountAmount: calculateItemDiscount(item_9)
                    })),
                cashAmount,
                transferAmount,
                bankName: transferAmount > 0 ? bankName : null
            };
            const response_2 = await fetch('/api/transactions', {
                method: 'POST',
                headers: {
            ...
            if (response_2.ok) {
                const transaction = await response_2.json();
    ...
    const printReceipt = ()=>{
      ...
      <body>
        <div class="receipt">
          ...
          <div class="items">
            ${(lastTransaction.items || []).map((item_10)=>{
            const itemDiscount = item_10.discountType === 'percentage' ? item_10.price * item_10.quantity * item_10.discount / 100 : item_10.discount;
            return `
                <div class="item">
                  <span>${item_10.name}</span>
                </div>
                <div class="item">
                  <span>${item_10.quantity} x Rp ${item_10.price.toLocaleString('id-ID')}</span>
                  <span>Rp ${(item_10.quantity * item_10.price).toLocaleString('id-ID')}</span>
                </div>
                ${item_10.discount > 0 ? `<div class="item"><span>Diskon ${item_10.discountType === 'percentage' ? item_10.discount + '%' : 'Rp ' + item_10.discount.toLocaleString('id-ID')}:</span><span>-Rp ${itemDiscount.toLocaleString('id-ID')}</span></div>` : ''}
              `;
        }).join('')}
          </div>
          ...
          <div class="total">
            ...
            const subtotal_1 = items.reduce((sum, item_11)=>sum + item_11.price * item_11.quantity, 0);
            const totalDiscount = items.reduce((sum_0, item_12)=>{
                const discount_0 = item_12.discountType === 'percentage' ? item_12.price * item_12.quantity * item_12.discount / 100 : item_12.discount;
                return sum_0 + discount_0;
            }, 0);
            const total_4 = subtotal_1 - totalDiscount;
            const cash = lastTransaction.cashAmount || 0;
            const transfer = lastTransaction.transferAmount || 0;
            const kembalian = Math.max(0, cash + transfer - total_4);
            return `
                <div class="item"><span>Subtotal:</span><span>Rp ${subtotal_1.toLocaleString('id-ID')}</span></div>
                ${totalDiscount > 0 ? `<div class="item"><span>Total Diskon:</span><span>-Rp ${totalDiscount.toLocaleString('id-ID')}</span></div>` : ''}
                <div class="item"><strong><span>TOTAL:</span><span>Rp ${total_4.toLocaleString('id-ID')}</span></strong></div>
                <p>================================</p>
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                    ...
                                                    onKeyPress: (e_0)=>e_0.key === 'Enter' && scanBarcode(),
                                                    className: "flex-1"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                    lineNumber: 556,
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                                        children: products.map((product_2)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                        children: [
                                                                            "Rp ",
                                                                            product_2.sellPrice.toLocaleString()
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                                        lineNumber: 597,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                            size: "sm",
                                                                            onClick: ()=>addToCart(product_2),
                                                                            disabled: product_2.currentStock <= 0,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        children: cart.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            className: "space-y-4",
                                            children: cart.map((item_13)=>{
                                                const itemSubtotal = item_13.price * item_13.quantity;
                                                const itemDiscount_0 = calculateItemDiscount(item_13);
                                                const itemTotal = itemSubtotal - itemDiscount_0;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    item_13.discount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "text-xs text-red-600",
                                                                        children: [
                                                                            "Diskon: ",
                                                                            item_13.discountType === 'percentage' ? `${item_13.discount}%` : `Rp ${item_13.discount.toLocaleString()}`,
                                                                            ' ',
                                                                            "(-Rp ",
                                                                            itemDiscount_0.toLocaleString(),
                                                                            ")"
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                            size: "sm",
                                                                            variant: "outline",
                                                                            onClick: ()=>updateQuantity(item_13.barcode, item_13.quantity - 1),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                            size: "sm",
                                                                            variant: "outline",
                                                                            onClick: ()=>openDiscountDialog(item_13),
                                                                            title: "Diskon",
                                                                            children: "%"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                            size: "sm",
                                                                            variant: "destructive",
                                                                            onClick: ()=>removeFromCart(item_13.barcode),
                                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trash$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Trash2$3e$__["Trash2"], {
                                                                                className: "h-3 w-3"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                        ...
                                        (paymentMethod === 'cash' || paymentMethod === 'split') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                    ...
                                                    type: "number",
                                                    value: cashAmount,
                                                    onChange: (e_1)=>setCashAmount(parseFloat(e_1.target.value) || 0),
                                                    placeholder: "0"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                    lineNumber: 738,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            ...
                                                            onChange: (e_2)=>setTransferAmount(parseFloat(e_2.target.value) || 0),
                                                            placeholder: "0"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/pos/page.tsx",
                                                            lineNumber: 749,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            id: "bankName",
                                                            value: bankName,
                                                            onChange: (e_3)=>setBankName(e_3.target.value),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                            ...
                                            type: "number",
                                            value: discountValue,
                                            onChange: (e_4)=>setDiscountValue(parseFloat(e_4.target.value) || 0),
                                            placeholder: "0",
                                            min: "0",
...
_s(POSPage, "+mP77M0C0BVCU6v5gBJuSctptd0=", false, function() {
    return [
