...
function useAuth() {
    ...
    if ($[0] !== "998050e96138fcce69cc22d73486a68f4a578f30eeeaae6f7af0d9db282825c8") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "998050e96138fcce69cc22d73486a68f4a578f30eeeaae6f7af0d9db282825c8";
    }
...
function AuthProvider({ children }) {
    ...
    const checkSession = async ()=>{
        try {
            const user_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientSession"])();
            setUser(user_0);
        } catch (error) {
    ...
    const signOut = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientSignOut"])();
            setUser(null);
...
//# sourceMappingURL=_5ad1b8dc._.js.map