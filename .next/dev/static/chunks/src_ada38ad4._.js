...
function LoginPage() {
    ...
    const { refreshSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$providers$2f$session$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setIsLoading(true);
        setError('');
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientSignIn"])(email, password);
            if (result.success) {
...
_s(LoginPage, "Pa5vJHoz4534sPEYmjTHTCvpdPQ=", false, function() {
    return [
...
//# sourceMappingURL=src_ada38ad4._.js.map