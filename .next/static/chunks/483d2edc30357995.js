(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,6372,t=>{"use strict";t.s(["generatePrintHTML",0,(t,a,e)=>{let i=t.map(t=>`
    <div class="barcode-label">
      ${t.productName?`<div class="product-name">${t.productName.toUpperCase()}</div>`:""}
      <div class="barcode-image">
        <canvas class="barcode-canvas" data-barcode="${t.barcode}"></canvas>
      </div>
      <div class="barcode-number">${t.barcode}</div>
      ${t.price?`<div class="price">${e(t.price)}</div>`:""}
    </div>
  `).join("");return`
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <style>
        * {
        ...
        @media print {
          @page {
            size: ${"58mm"===a?"58mm auto":"80mm auto"};
            margin: 0;
          }
        ...
        .barcode-container {
          ...
          flex-wrap: wrap;
          gap: 1mm;
          justify-content: ${1===t.length?"center":"flex-start"};
          align-items: flex-start;
        }
        
        .barcode-label {
          width: ${"58mm"===a?"54mm":"76mm"};
          height: ${"58mm"===a?"24mm":"28mm"};
          padding: 0.5mm;
          display: flex;
        ...
        .product-name {
          font-size: ${"58mm"===a?"5pt":"7pt"} !important;
          font-weight: bold !important;
          text-align: center !important;
          line-height: 0.8 !important;
          height: ${"58mm"===a?"3mm":"4mm"};
          overflow: hidden;
        ...
        .barcode-canvas {
          ...
          height: ${"58mm"===a?"15px":"20px"} !important;
        ...
        .barcode-number {
          font-size: ${"58mm"===a?"7pt":"10pt"} !important;
          font-weight: bold !important;
        ...
        .price {
          font-size: ${"58mm"===a?"9pt":"12pt"} !important;
          font-weight: bold !important;
          color: #000 !important;
          margin: 0 !important;
          padding: 0 !important;
